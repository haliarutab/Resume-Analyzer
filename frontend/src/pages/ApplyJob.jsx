...
import ATSAnalyzer from "../components/ATSAnalyzer"; // ✅ NEW
      ...
      <section>
            ...
            <div className="flex-1 mb-6 md:mb-0">
              ...
              <div className="flex flex-wrap items-center gap-4 text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    RS.{" "}
                    {jobData?.salary ? jobData.salary.toLocaleString() : "Not disclosed"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-1/2 xl:w-2/3">
            ...
            {/* ✅ AI Resume Analyzer — only shown when user is logged in */}
            {userData && (
              <ATSAnalyzer jobId={jobData?._id} />
            )}
          </div>
